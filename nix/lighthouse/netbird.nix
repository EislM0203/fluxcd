{
  ...
  cfg = {
    ...
    keycloakDomain = "pocketid.cloud.icylair.com";
    keycloakURL = "https://pocketid.cloud.icylair.com";
    keycloak_openid_url = "https://pocketid.cloud.icylair.com/realms/master/.well-known/openid-configuration";
